    ...
    <>
      ...
      <main className="mt-12">
        ...
        <div className="mt-12 flex space-x-4">
          <a className="flex items-center space-x-1" href="https://www.linkedin.com/in/aminbadh/" target="_blank"><Image className="inline" src={"/icons8-linkedin.svg"} width={18} height={18}/> <span>LinkedIn</span></a>
          <a className="flex items-center space-x-1" href="https://github.com/aminbadh/" target="_blank"><Image className="inline" src={"/icons8-github.svg"} width={18} height={18}/> <span>GitHub</span></a>
          <a className="flex items-center space-x-1" href="https://www.facebook.com/aminbadh/" target="_blank"><Image className="inline" src={"/icons8-facebook.svg"} width={18} height={18}/> <span>Facebook</span></a>
          <span></span>
